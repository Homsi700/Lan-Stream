...
import { Clapperboard, Home, LogOut, Moon, Sun, Languages, Users, ShieldCheck } from 'lucide-react';
          ...
          {userRole === 'admin' && (
            ...
            <SidebarMenuItem>
              <SidebarMenuButton 
                ...
                isActive={pathname.startsWith('/dashboard/settings/access-control')}
                tooltip={t('sidebar.accessControl')}
              >
                <ShieldCheck />
